...
public class ApiOperationLogAspect {
    ...
    // 定义切点，匹配所有被 @ApiOperationLog 注解的方法
    @Pointcut("@annotation(top.crushtj.blog.common.aspect.ApiOperationLog)")
    ...
    /**
     * 获取 @ApiOperationLog 注解的 description 属性值
     *
     * @param joinPoint 切点
     * @return description 属性值
     */
