...
import top.crushtj.blog.jwt.filter.JwtAuthenticationFilter;
import top.crushtj.blog.jwt.handler.RestAuthenticationFailureHandler;
import top.crushtj.blog.jwt.handler.RestAuthenticationSuccessHandler;

/**
 * @author 刑加一
 * @url www.crushtj.top
 * @date 2025/10/11
 * @description JWT 认证安全配置
 */
